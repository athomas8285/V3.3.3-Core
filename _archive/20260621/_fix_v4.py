...
# Build disclaimer with actual Unicode characters
warn = "\u26a0\ufe0f"
...
# Insert BEFORE main_close (inside .main)
...
with open("D:/V3.3.3-Core/templates/index.html", "rb") as f:
    d = f.read()
cnt = d.count(b"ft-disclaimer")
sz = len(d)
print(f"Size: {sz}, ft-disclaimer count: {cnt}")
print(f"Disclaimer at byte {d.find(b'ft-disclaimer')}, script at byte {d.find(b'<script>', 68000)}")
